...
#[allow(dead_code)]
pub fn identifier<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn identifier_nondigit<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn nondigit<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn universal_character_name<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn hex_quad<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn constant<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn integer_constant<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn decimal_constant<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn binary_constant<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn binary_prefix<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn binary_digit<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn octal_constant<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn hexadecimal_constant<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn hexadecimal_prefix<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn nonzero_digit<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn octal_digit<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn hexadecimal_digit<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn integer_suffix<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn unsigned_suffix<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn long_suffix<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn long_long_suffix<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn floating_constant<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn decimal_floating_constant<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn hexadecimal_floating_constant<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn fractional_constant<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn exponent_part<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn digit_sequence<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn binary_exponent_part<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn hexadecimal_digit_sequence<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn floating_suffix<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn enumeration_constant<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn character_constant<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn c_char_sequence<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn c_char<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn octal_escape_sequence<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn hexadecimal_escape_sequence<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn string_literal<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn encoding_prefix<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn s_char_sequence<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn s_char<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn header_name<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn h_char_sequence<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn h_char<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn q_char_sequence<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn q_char<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn pp_number<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
    ...
    let closure_7 =
        _var_name_indirect_left_recursion(&involved_set, Rules::Pp_number, context, pp_number);
    ...
    let closure_12 =
        _var_name_indirect_left_recursion(&involved_set, Rules::Pp_number, context, pp_number);
    let closure_13 = _var_name(Rules::Identifier_nondigit, context, identifier_nondigit);
    let closure_14 = _sequence(&closure_12, &closure_13);
    let closure_15 = _subexpression(&closure_14);
...
#[allow(dead_code)]
pub fn primary_expression<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn generic_assoc_list<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn generic_association<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn postfix_expression<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn argument_expression_list<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn unary_expression<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn unary_operator<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn cast_expression<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn multiplicative_expression<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn additive_expression<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn shift_expression<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn relational_expression<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn equality_expression<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn and_expression<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn exclusive_or_expression<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn inclusive_or_expression<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn logical_and_expression<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn logical_or_expression<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn conditional_expression<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn assignment_expression<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn assignment_operator<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn constant_expression<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn declaration<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
    ...
    let closure_2 = _var_name(Rules::Attribute_seq, context, attribute_seq);
    let closure_3 = _optional(&closure_2);
    let closure_4 = _sequence(&closure_1, &closure_3);
    let closure_5 = _var_name(Rules::Init_declarator_list, context, init_declarator_list);
    let closure_6 = _optional(&closure_5);
    let closure_7 = _sequence(&closure_4, &closure_6);
    let closure_8 = _terminal(b';');
    let closure_9 = _sequence(&closure_7, &closure_8);
...
#[allow(dead_code)]
pub fn declaration_specifiers<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn attribute<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn init_declarator_list<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn extended_decl_modifier_seq<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn extended_decl_modifier<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn type_specifier<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
    ...
    let closure_35 = _ordered_choice(&closure_33, &closure_34);
    let involved_set: Vec<Rules> = [Rules::Identifier, Rules::Typedef_name].to_vec();
...
#[allow(dead_code)]
pub fn struct_or_union_specifier<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn struct_declaration_list<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn function_specifier<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn alignment_specifier<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn declarator<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn direct_declarator<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
    ...
    let closure_8 = _terminal(b'[');
    let closure_9 = _sequence(&closure_7, &closure_8);
    let closure_10 = _var_name(Rules::Type_qualifier_list, context, type_qualifier_list);
    ...
    let closure_24 = _sequence(&closure_22, &closure_23);
    let closure_25 = _var_name(Rules::Type_qualifier_list, context, type_qualifier_list);
    ...
    let closure_37 = _var_name(Rules::Type_qualifier_list, context, type_qualifier_list);
    ...
    let closure_48 = _terminal(b'[');
    let closure_49 = _sequence(&closure_47, &closure_48);
    let closure_50 = _var_name(Rules::Type_qualifier_list, context, type_qualifier_list);
    ...
    let closure_62 = _var_name(Rules::Parameter_type_list, context, parameter_type_list);
    let closure_63 = _sequence(&closure_61, &closure_62);
    let closure_64 = _terminal(b')');
    let closure_65 = _sequence(&closure_63, &closure_64);
    let closure_66 = _subexpression(&closure_65);
    let closure_67 = _ordered_choice(&closure_58, &closure_66);
    let involved_set: Vec<Rules> = [Rules::Direct_declarator].to_vec();
    let closure_68 = _var_name_indirect_left_recursion(
        &involved_set,
        Rules::Direct_declarator,
        context,
        direct_declarator,
    ...
    let closure_72 = _optional(&closure_71);
    let closure_73 = _sequence(&closure_70, &closure_72);
    let closure_74 = _terminal(b')');
    let closure_75 = _sequence(&closure_73, &closure_74);
    let closure_76 = _subexpression(&closure_75);
    let closure_77 = _ordered_choice(&closure_67, &closure_76);
    let involved_set: Vec<Rules> = [Rules::Identifier].to_vec();
    let closure_78 =
        _var_name_indirect_left_recursion(&involved_set, Rules::Identifier, context, identifier);
    let closure_79 = _ordered_choice(&closure_77, &closure_78);
...
pub fn pointer<T: Context + 'static>(
    ...
    let closure_1 = _terminal(b'*');
    let closure_2 = _var_name(Rules::Type_qualifier_list, context, type_qualifier_list);
    let closure_3 = _optional(&closure_2);
    let closure_4 = _sequence(&closure_1, &closure_3);
    let closure_5 = _subexpression(&closure_4);
    let closure_6 = _terminal(b'*');
    let closure_7 = _var_name(Rules::Type_qualifier_list, context, type_qualifier_list);
    let closure_8 = _optional(&closure_7);
    let closure_9 = _sequence(&closure_6, &closure_8);
...
#[allow(dead_code)]
pub fn type_qualifier_list<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
) -> (bool, u32) {
    let closure_1 = _var_name(Rules::Type_qualifier, context, type_qualifier);
    let closure_2 = _var_name(Rules::Type_qualifier_list, context, type_qualifier_list);
    let closure_3 = _var_name(Rules::Type_qualifier, context, type_qualifier);
    let closure_4 = _sequence(&closure_2, &closure_3);
    let closure_5 = _subexpression(&closure_4);
    let closure_6 = _ordered_choice(&closure_1, &closure_5);
    closure_6(parent, source, position)
...
#[allow(dead_code)]
pub fn parameter_type_list<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
) -> (bool, u32) {
    let closure_1 = _var_name(Rules::Parameter_list, context, parameter_list);
    let closure_2 = _var_name(Rules::Parameter_list, context, parameter_list);
    let closure_3 = _terminal(b',');
    let closure_4 = _sequence(&closure_2, &closure_3);
...
#[allow(dead_code)]
pub fn parameter_list<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
) -> (bool, u32) {
    let closure_1 = _var_name(Rules::Parameter_declaration, context, parameter_declaration);
    let closure_2 = _var_name(Rules::Parameter_list, context, parameter_list);
    let closure_3 = _terminal(b',');
    let closure_4 = _sequence(&closure_2, &closure_3);
    let closure_5 = _var_name(Rules::Parameter_declaration, context, parameter_declaration);
    let closure_6 = _sequence(&closure_4, &closure_5);
    let closure_7 = _subexpression(&closure_6);
    let closure_8 = _ordered_choice(&closure_1, &closure_7);
    closure_8(parent, source, position)
...
#[allow(dead_code)]
pub fn parameter_declaration<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
    ...
    let closure_6 = _var_name(Rules::Abstract_declarator, context, abstract_declarator);
    let closure_7 = _optional(&closure_6);
    let closure_8 = _sequence(&closure_5, &closure_7);
    let closure_9 = _subexpression(&closure_8);
    let closure_10 = _ordered_choice(&closure_4, &closure_9);
    closure_10(parent, source, position)
}
#[allow(dead_code)]
pub fn identifier_list<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn abstract_declarator<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn direct_abstract_declarator<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
    ...
    let closure_61 = _terminal(b'(');
    let closure_62 = _sequence(&closure_60, &closure_61);
    let closure_63 = _var_name(Rules::Parameter_type_list, context, parameter_type_list);
...
#[allow(dead_code)]
pub fn typedef_name<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn initializer<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn initializer_list<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn designation<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn designator_list<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn designator<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn static_assert_declaration<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
pub fn statement<T: Context + 'static>(
    ...
    let involved_set: Vec<Rules> = [Rules::Identifier, Rules::Labeled_statement].to_vec();
    let closure_1 = _var_name_indirect_left_recursion(
        &involved_set,
    ...
    let closure_5 = _ordered_choice(&closure_3, &closure_4);
    let closure_6 = _var_name(Rules::Selection_statement, context, selection_statement);
    let closure_7 = _ordered_choice(&closure_5, &closure_6);
    let closure_8 = _var_name(Rules::Iteration_statement, context, iteration_statement);
    let closure_9 = _ordered_choice(&closure_7, &closure_8);
    let closure_10 = _var_name(Rules::Jump_statement, context, jump_statement);
    let closure_11 = _ordered_choice(&closure_9, &closure_10);
    let closure_12 = _var_name(Rules::Try_except_statement, context, try_except_statement);
    let closure_13 = _ordered_choice(&closure_11, &closure_12);
    let closure_14 = _var_name(Rules::Try_finally_statement, context, try_finally_statement);
    let closure_15 = _ordered_choice(&closure_13, &closure_14);
    closure_15(parent, source, position)
}
#[allow(dead_code)]
pub fn jump_statement<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
) -> (bool, u32) {
    let closure_1 = _string_terminal_opt_ascii(b"goto");
    let involved_set: Vec<Rules> = [Rules::Identifier].to_vec();
    let closure_2 =
        _var_name_indirect_left_recursion(&involved_set, Rules::Identifier, context, identifier);
    let closure_3 = _sequence(&closure_1, &closure_2);
    ...
    let closure_5 = _sequence(&closure_3, &closure_4);
    let closure_6 = _subexpression(&closure_5);
    let closure_7 = _string_terminal_opt_ascii(b"continue");
    let closure_8 = _terminal(b';');
    let closure_9 = _sequence(&closure_7, &closure_8);
    let closure_10 = _subexpression(&closure_9);
    let closure_11 = _ordered_choice(&closure_6, &closure_10);
    let closure_12 = _string_terminal_opt_ascii(b"break");
    let closure_13 = _terminal(b';');
    let closure_14 = _sequence(&closure_12, &closure_13);
    let closure_15 = _subexpression(&closure_14);
    let closure_16 = _ordered_choice(&closure_11, &closure_15);
    let closure_17 = _string_terminal_opt_ascii(b"return");
    let involved_set: Vec<Rules> = [
        Rules::AND_expression,
        Rules::Additive_expression,
        Rules::Assignment_expression,
    ...
    let closure_23 = _subexpression(&closure_22);
    let closure_24 = _ordered_choice(&closure_16, &closure_23);
    let closure_25 = _string_terminal_opt_ascii(b"__leave");
    let closure_26 = _terminal(b';');
    let closure_27 = _sequence(&closure_25, &closure_26);
    let closure_28 = _subexpression(&closure_27);
    let closure_29 = _ordered_choice(&closure_24, &closure_28);
    closure_29(parent, source, position)
}
#[allow(dead_code)]
pub fn compound_statement<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn declaration_list<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
pub fn statement_list<T: Context + 'static>(
    ...
    .to_vec();
    let closure_1 =
        _var_name_indirect_left_recursion(&involved_set, Rules::Statement, context, statement);
    let involved_set: Vec<Rules> = [
        Rules::AND_expression,
        Rules::Additive_expression,
        Rules::Assignment_expression,
...
#[allow(dead_code)]
pub fn expression_statement<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn iteration_statement<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn selection_statement<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn labeled_statement<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn try_except_statement<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn try_finally_statement<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn translation_unit<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
...
#[allow(dead_code)]
pub fn external_declaration<T: Context + 'static>(
    parent: Key,
    context: &RefCell<T>,
    source: &Source,
    position: u32,
