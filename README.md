...
| Hooked Call| <function_name>() | This allows you to create custom functions that execute arbitrary code that still seamlessly interoperate with other rules, This allows you to parse context sensitive code, for example typedefs in C. See example_11 in examples to see how to use it in more details| <Is_Unique_Line> = my_custom_unique_line_checker((!'\n',<ASCII\>)*, '\n');
