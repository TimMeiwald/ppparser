...
#[allow(dead_code)]
pub fn onenine<T: Context + 'static>(parent: Key, context: &RefCell<T>, source: &Source, position: u32) -> (bool, u32) {
...
pub fn integer<T: Context + 'static>(parent: Key, context: &RefCell<T>, source: &Source, position: u32) -> (bool, u32) {
	...
	let closure_2 = move |parent: Key, source: &Source, position: u32| onenine(parent, context, source, position);
	let closure_3 = move |parent: Key, source: &Source, position: u32| digit(parent, context, source, position);
	let closure_4 = _one_or_more(&closure_3);
	let closure_5 = _sequence(&closure_2, &closure_4);
	let closure_6 = _subexpression(&closure_5);
	let closure_7 = move |parent: Key, source: &Source, position: u32| digit(parent, context, source, position);
...
#[allow(dead_code)]
pub fn number<T: Context + 'static>(parent: Key, context: &RefCell<T>, source: &Source, position: u32) -> (bool, u32) {
...
#[allow(dead_code)]
pub fn fraction<T: Context + 'static>(parent: Key, context: &RefCell<T>, source: &Source, position: u32) -> (bool, u32) {

	let closure_1 = _terminal(b'.');
	let closure_2 = move |parent: Key, source: &Source, position: u32| digit(parent, context, source, position);
...
#[allow(dead_code)]
pub fn exponent<T: Context + 'static>(parent: Key, context: &RefCell<T>, source: &Source, position: u32) -> (bool, u32) {
...
pub fn addition<T: Context + 'static>(parent: Key, context: &RefCell<T>, source: &Source, position: u32) -> (bool, u32) {
	...
	let involved_set: Vec<Rules> = [Rules::Expr, Rules::Addition, Rules::Subtraction].to_vec();
	...
	let involved_set: Vec<Rules> = [Rules::Term, Rules::Multiplication, Rules::Division].to_vec();
...
#[allow(dead_code)]
pub fn multiplication<T: Context + 'static>(parent: Key, context: &RefCell<T>, source: &Source, position: u32) -> (bool, u32) {
...
#[allow(dead_code)]
pub fn division<T: Context + 'static>(parent: Key, context: &RefCell<T>, source: &Source, position: u32) -> (bool, u32) {
...
#[allow(dead_code)]
pub fn power<T: Context + 'static>(parent: Key, context: &RefCell<T>, source: &Source, position: u32) -> (bool, u32) {
...
#[allow(dead_code)]
pub fn expr<T: Context + 'static>(parent: Key, context: &RefCell<T>, source: &Source, position: u32) -> (bool, u32) {

	let involved_set: Vec<Rules> = [Rules::Addition, Rules::Expr].to_vec();
	let closure_1 = _var_name_indirect_left_recursion(&involved_set, Rules::Addition, context, addition);
	let involved_set: Vec<Rules> = [Rules::Expr, Rules::Subtraction].to_vec();
	let closure_2 = _var_name_indirect_left_recursion(&involved_set, Rules::Subtraction, context, subtraction);
	let closure_3 = _ordered_choice(&closure_1, &closure_2);
	let involved_set: Vec<Rules> = [Rules::Term, Rules::Multiplication, Rules::Division].to_vec();
	let closure_4 = _var_name_indirect_left_recursion(&involved_set, Rules::Term, context, term);
...
#[allow(dead_code)]
pub fn power_expr<T: Context + 'static>(parent: Key, context: &RefCell<T>, source: &Source, position: u32) -> (bool, u32) {
...
#[allow(dead_code)]
pub fn factor<T: Context + 'static>(parent: Key, context: &RefCell<T>, source: &Source, position: u32) -> (bool, u32) {
