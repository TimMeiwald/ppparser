...
pub fn addition<T: Context + 'static>(parent: Key, context: &RefCell<T>, source: &Source, position: u32) -> (bool, u32) {
	...
	let involved_set: Vec<Rules> = [Rules::Addition, Rules::Subtraction, Rules::Expr].to_vec();
	...
	let involved_set: Vec<Rules> = [Rules::Multiplication, Rules::Term, Rules::Division].to_vec();
