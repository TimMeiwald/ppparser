...
B,
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::AlphabetUpper as i32, position, source);
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::AlphabetLower as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Num as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Spaces as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Specials as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Ascii as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Apostrophe as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::LeftAngleBracket as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::RightAngleBracket as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::LeftBracket as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::RightBracket as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Assignment as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::EndRule as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Ampersand as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::ExclamationMark as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Plus as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Star as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::QuestionMark as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Comma as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Backslash as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::VarName as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Subexpression as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Epsilon as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Lterminal as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Nucleus as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Atom as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::AndPredicate as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::NotPredicate as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Sequence as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::OrderedChoice as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::OneOrMore as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::ZeroOrMore as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Optional as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Whitespace as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Rhs as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Lhs as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Rule as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Grammar as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Comment as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::SemanticInstructions as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Delete as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Passthrough as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
    ...
    fn resolve(&self, stack: &mut Stack, cache: &mut Cache, position: i32, source: &str) -> (bool, i32) { 
        ...
        let e_position = stack.push(e);
        let hook = cache_struct_wrapper(stack, cache, rule, Rules::Collect as i32, position, source);
        stack.unravel(hook.0, position, hook.1, e_position);
        return hook;
        }
    }
